import ProductJsonConfig from "config/Product_Information_form_fullform_config.json";
...
,    { source: "PrPrice", target: "productprice", expand: "PrPrice", exclude: [], func: Support.AddOrUpdateProductPrice }
        ...
        if (productId) {
            ...
            if (rslt.status) {
                ...
                if (product.MainImage) {
                    ...
                    if (tmp.DocId > 0) {
                        rslt = await Api.GetDocumentSingle(tmp.DocId, true);
