...
const columns = [
    { headerName: "Product_Id", field: "Product_id", flex: 1 },
    { headerName: "Product_Name", field: "Name", flex: 1 },
    { headerName: "Size", field: "Size", flex: 1 },
    { headerName: "Product_Description", field: "Product_description", flex: 1 },
    { headerName: "Product_Type", field: "ProductTypeName", flex: 1 },
    { headerName: "Product_Type", field: "ProductTypeDesc", flex: 1 },
                ...
                if (res.status) {
                    ...
                    if (_rows.length > 0) {
                        _rows.forEach(x => {
                            ...
                            x.ProductTypeName = x.ProductType?.ProductTypeName || 'NA';
