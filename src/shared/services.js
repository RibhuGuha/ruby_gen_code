...
const GetDocumentSingle = async (id, value) => {
    return new Promise(async (resolve) => {
        let url = `${serverApi}Documents(${id})`;
        if (value) {
...
const SetDocumentSingle = async (input, headers) => {
    return new Promise(async (resolve) => {
